...
namespace EvolveGames
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [SerializeField, Range(0.01f, 10)] float walkingSpeed = 3f;
        [Range(0.1f, 5)] public float CroughSpeed = 3f;
        [SerializeField, Range(2, 20)] float RuningSpeed = 3f;
        [SerializeField, Range(0, 20)] float jumpSpeed = 0f;
        [SerializeField, Range(0.5f, 10)] float lookSpeed = 5.0f;
        [SerializeField, Range(10, 120)] float lookXLimit = 80.0f;
        [Space(20)]
        [Header("Advance")]
        [SerializeField] float RunningFOV = 70.0f;
        ...
        [HideInInspector] public bool CanRunning = false;

        [Space(20)]
        [Header("Climbing")]
        [SerializeField] bool CanClimbing = true;
        [SerializeField, Range(1, 25)] float Speed = 3f;
